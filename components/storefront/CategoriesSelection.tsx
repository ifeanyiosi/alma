    ...
    <div className="py-24 sm:py-10">
      ...
      <div className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg:gap-8">
        <div className="group aspect-w-2 aspect-h-1 rounded-xl overflow-hidden sm:aspect-w-1 sm:row-span-2">
          ...
          <div className="p-6 flex bg-black/90 items-start">
        ...
        <div className="group aspect-w-2 aspect-h-1 bg-black rounded-lg overflow-hidden sm:relative sm:aspect-none sm:h-full">
          <Image
            src={men}
